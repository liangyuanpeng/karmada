...
func (c *FakeAppsV1alpha1) CrossClusterStatefulSets(namespace string) v1alpha1.CrossClusterStatefulSetInterface {
	return &FakeCrossClusterStatefulSets{c, namespace}
}
