...
func (i *CommandInitOption) initKarmadaAPIServer() error {
	...
	if err := utils.CreateDeployAndWait(i.KubeClientSet, i.Namespace, karmadaAPIServerDeployment, i.WaitComponentReadyTimeout); err != nil {
		return err
	}
	...
	if err := utils.CreateDeployAndWait(i.KubeClientSet, i.Namespace, karmadaAggregatedAPIServerDeployment, i.WaitComponentReadyTimeout); err != nil {
		klog.Warning(err)
	}
	return nil
}
...
func (i *CommandInitOption) initKarmadaComponent() error {
	...
	if err := utils.CreateDeployAndWait(i.KubeClientSet, i.Namespace, karmadaKubeControllerManagerDeployment, i.WaitComponentReadyTimeout); err != nil {
		klog.Warning(err)
	}
	...
	if err := utils.CreateDeployAndWait(i.KubeClientSet, i.Namespace, karmadaSchedulerDeployment, i.WaitComponentReadyTimeout); err != nil {
		klog.Warning(err)
	}
	...
	if err := utils.CreateDeployAndWait(i.KubeClientSet, i.Namespace, karmadaControllerManagerDeployment, i.WaitComponentReadyTimeout); err != nil {
		klog.Warning(err)
	}
	...
	if err := utils.CreateDeployAndWait(i.KubeClientSet, i.Namespace, karmadaWebhookDeployment, i.WaitComponentReadyTimeout); err != nil {
		klog.Warning(err)
	}
	return nil
}
