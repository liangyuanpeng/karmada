...
func NewCmdInit(parentCommand string) *cobra.Command {
	...
	flags.StringVarP(&opts.EtcdInitImage, "etcd-init-image", "", images.DefaultInitImage, "etcd init container image")
	...
	flags.StringVarP(&opts.KarmadaSchedulerImage, "karmada-scheduler-image", "", images.DefaultKarmadaSchedulerImage, "Karmada scheduler image")
	...
	flags.StringVarP(&opts.KarmadaControllerManagerImage, "karmada-controller-manager-image", "", images.DefaultKarmadaControllerManagerImage, "Karmada controller manager image")
	...
	flags.StringVarP(&opts.KarmadaWebhookImage, "karmada-webhook-image", "", images.DefualtKarmadaWebhookImage, "Karmada webhook image")
	flags.Int32VarP(&opts.KarmadaWebhookReplicas, "karmada-webhook-replicas", "", 1, "Karmada webhook replica set")
	flags.StringVarP(&opts.KarmadaAggregatedAPIServerImage, "karmada-aggregated-apiserver-image", "", images.DefaultKarmadaAggregatedAPIServerImage, "Karmada aggregated apiserver image")
