...
set +e
ginkgo --focus="Aggregated Kubernetes API Endpoint testing"  --junit-report $ARTIFACTS_PATH/junit.xml --json-report /tmp/karmada/report.json -v --race --trace --fail-fast -p --randomize-all ./test/e2e/ -- --karmada-context=karmada-apiserver 
TESTING_RESULT=$?
